# -*- coding: utf-8 -*-
"""Copy of Week1_Applied Agentic AI program.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1gSExuJAhrYTYclP31D0soTbtSO-_6Adg
"""
...
tools_schema = [
    ...
    # --- >>>> TASK 3: Define Schema for restart_service ---
    {
        ...
        "function": {
            ...
            "description": "CPU is critical (>90%), it should Restart the service",
            "parameters": {
                "type": "object",
                "properties": {
                    # ### TODO: Define the 'server_id' parameter here
                    "server_id": {"type": "string", "description": "CPU is critical (>90%), it should Restart the service."}
                },
                "required": ["server_id"]
            }
        }
